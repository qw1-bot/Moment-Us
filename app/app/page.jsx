...
function PairPage({ inviteCode, onGenerateCode, onEnterSpace, inputCode, setInputCode }) {
  return (
      ...
      <div className="max-w-md mx-auto space-y-6">
        ...
        <div className="rounded-3xl bg-white shadow-md p-5 space-y-4">
          <div>
            ...
            <p className="text-sm text-[#8B7470] mt-1">把邀请码分享给对方，一起进入同一个空间。</p>
          </div>
        ...
        <div className="rounded-3xl bg-white shadow-md p-5 space-y-4">
          <div>
            ...
            <p className="text-sm text-[#8B7470] mt-1">输入后，就能建立属于你们的共同空间。</p>
          </div>
...
function TimelinePage({ records, onAdd }) {
  return (
    <div className="min-h-screen bg-cheese px-5 pt-8 pb-24 relative">
      <div className="max-w-md mx-auto">
        <h2 className="text-2xl font-bold text-center text-[#7D5A5A] mb-8">我们的记录</h2>
                  ...
                  <div key={record.id} className="relative">
                    ...
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span className="text-xs text-[#9B8884]">{record.date}</span>
                      </div>
    ...
    <div className="min-h-screen bg-cheese px-5 py-8">
      <div className="max-w-md mx-auto space-y-5">
        ...
        <div className="rounded-3xl bg-white shadow-md p-4">
          ...
          <div className="text-right text-xs text-[#A2908D] mt-2">{remaining}/200</div>
        </div>
...
export default function App() {
  ...
  const handleEnterSpace = () => {
    if (inputCode.trim() && inputCode.trim() === inviteCode) {
      setPage("timeline");
    }
  };
  ...
  if (page === "add") {
    return <AddRecordPage onSave={handleSaveRecord} onBack={() => setPage("timeline")} />;
  }

  return <TimelinePage records={sortedRecords} onAdd={() => setPage("add")} />;
}
```
